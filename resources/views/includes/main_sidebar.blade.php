                                        ...
                                        >
                                            <img
                                                src="{{
                                                    ...
                                                    ? str_replace('https://', 'https://i2.wp.com/', $dailyViews->poster)
                                        ...
                                        >
                                            <img
                                                src="{{
                                                    ...
                                                    ? str_replace('https://', 'https://i2.wp.com/', $weeklyViews->poster)
                                        ...
                                        >
                                            <img
                                                src="{{
                                                    ...
                                                    ? str_replace('https://', 'https://i2.wp.com/', $monthlyViews->poster)
