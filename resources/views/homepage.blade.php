            ...
            <div class="text-center d-block">
                @foreach ($bannerTengah as $bannerTengah)
                    <a href="{{ $bannerTengah->link }}" target="_blank">
                        <img src="{{ config('constant.url.backend').'/banner/'.$bannerTengah->gambar }}" class="img-fluid mb-3" alt="">
                    </a>
                @endforeach
            </div>
        </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="item">
                                    ...
                                    <div class="number">
                                        <span>{{ $loop->iteration }}</span>
                                        <div class="anime-name">{{ substr($trending->manga->title,0,25). '...' }}</div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
            ...
            <div class="text-center">
                @foreach ($bannerRekomendasi as $bannerRekomendasi)
                    <a href="{{ $bannerRekomendasi->link }}" target="_blank">
                        <img src="{{ config('constant.url.backend').'/banner/'.$bannerRekomendasi->gambar }}" class="img-fluid">
                    </a>
                @endforeach
            </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="mg-item-basic">
                                        ...
                                        <div class="manga-detail">
                                            <h3 class="manga-name">
                                                <a href="{{ route('detail', str_replace('/manga/','',$recommended->manga['slug'])) }}" title="{{ $recommended->manga['title'] }}">
