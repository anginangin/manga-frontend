...
@section('less')
    ...
    "image": "{{ str_replace('https://', 'https://i2.wp.com/', $detailManga['poster']) }}",
                    ...
                    <div class="anisc-poster">
                        <div class="manga-poster">
                            <img src="{{ !$detailManga['thumbnail']
                                ? str_replace('https://', 'https://i2.wp.com/', $detailManga['poster'])
                                        ...
                                        <div class="item item-spc">
                                            <a class="manga-poster" href="{{ route('detail', $relatedManga['slug']) }}">
                                                <img src="{{ !$relatedManga['thumbnail']
                                                    ? str_replace('https://', 'https://i2.wp.com/', $relatedManga['poster'])
