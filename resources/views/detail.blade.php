            ...
            <div class="anis-content">
                ...
                <div class="anisc-detail">
                    ...
                    <div class="manga-buttons">
                        <a href="/read{{ $detailManga->chapters->last()->path }}" class="btn btn-primary btn-play smoothlink">
                        ...
                        <div class="dr-fav" id="reading-list-info">
                            ...
                            <form>
                                ...
                                <button type="button" class="btn btn-light btn-fav" id="unbookmark">
                                    <i class="fas fa-bookmark" style="color: {{ $setTheme->secondary_color }} !important"></i>
                                </button>
                            </form>
                            @else
                            <form>
                    ...
                    <div class="sort-desc">
                        ...
                        <div class="description-more">
                            <button type="button" data-toggle="modal" data-target="#modaldesc" class="btn btn-xs text-color">
                                + Read full
                            </button>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="background: {{ $setTheme->tertiary_base_color }} !important">
                            ...
                            <div class="anisc-info">
                                ...
                                <div class="dt-rate" id="vote-info">
                                    <div class="block-rating ">
                                        ...
                                        @if(Auth::check())
                                            @php $rate = \App\Models\Rating::where('manga_id', $detailManga['id'])->where('user_id',auth()->user()->id)->first() @endphp
                                            @if ($rate)
                                        ...
                                        <div class="form-group" id="rating-ability-wrapper">
                                            ...
                                            <a href="{{ route('sign-in') }}" class="btn btn-default btn-sm" data-attr="2" id="rating-star-2" disabled>
                                                <i class="fa fa-star text-color" aria-hidden="true"></i>
                                            </a>
                                            <a href="{{ route('sign-in') }}" class="btn btn-default btn-sm" data-attr="3" id="rating-star-3" disabled>
                                                <i class="fa fa-star text-color" aria-hidden="true"></i>
                                            </a>
                                            <a href="{{ route('sign-in') }}" class="btn btn-default btn-sm" data-attr="4" id="rating-star-4" disabled>
                                                <i class="fa fa-star text-color" aria-hidden="true"></i>
                                            </a>
                                            <a href="{{ route('sign-in') }}" class="btn btn-default btn-sm" data-attr="5" id="rating-star-5" disabled>
                                                <i class="fa fa-star text-color" aria-hidden="true"></i>
                                            </a>
                                        </div>
                                        @endif
                    ...
                    <div class="block_area-header mb-0">
                        <div class="bah-heading bah-heading-tabs">
                            <ul class="nav nav-tabs chap-tabs">
                                <li class="nav-item">
                                    <a data-toggle="tab" href="#list-chapter" class="nav-link active show text-color">
                                        List Chapter
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div id="list-chapter" class="tab-pane active show">
                            ...
                            <div class="chapters-list-ul">
                                <ul class="ulclear reading-list lang-chapters" id="en-chapters">
                                    ...
                                    <li class="item reading-item chapter-item" data-number="{{ floatval($chapter->chapter) }}">
                        ...
                        <div class="mls-wrap">
                            ...
                            <div class="item item-spc">
                                ...
                                <div class="manga-detail">
                                    <h3 class="manga-name">
                                        <a href="{{ route('detail', $relatedManga['slug']) }}" title="{{ $relatedManga['title'] }}">
                                            {{ $relatedManga['title'] }}
                                        </a>
                                    </h3>
                                    <div class="fd-infor">
