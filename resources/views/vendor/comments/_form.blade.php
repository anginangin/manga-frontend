    ...
    <div class="card-body"> --}}
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @if($errors->has('message')) is-invalid @endif" name="message" rows="3" style="background: {{ $setTheme->tertiary_base_color }};border: 1px solid {{ $setTheme->tertiary_base_color }};color: {{ $setTheme->text_color }}" placeholder="Mulai Berdiskusi..."></textarea>
                <div class="invalid-feedback">
            ...
            <button type="submit" class="btn btn-sm float-right text-dark" style="background: {{ $setTheme->button_color }} !important">Kirim</button>
        </form>
    {{-- </div>
</div> --}}
<br><br><br>